	...
	<header class="header-v2">
		...
		<div class="container-menu-desktop trans-03">
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->
					<a href="#" class="logo">
						<img src="assets/img/devian rd2.png" alt="Devia RD">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu">
								<a href="index.html">PLOTTER HIDROGEL</a>
								<ul class="sub-menu">
							...
							<li>
								<a href="product.html">PROTECTORES DE PANTALLA</a>
							</li>

							<li class="label1" data-label1="hot">
								<a href="shoping-cart.html">LAMINAS</a>
							</li>

							<li>
								<a href="about.html">ACCESORIOS PLOTTER</a>
							</li>
		...
		<div class="menu-mobile">
			<ul class="main-menu-m">
				...
				<li>
					<a href="shoping-cart.html" class="label1 rs1" data-label1="hot">LAMINAS VINILOS</a>
				</li>
					...
					<div class="flex-w flex-sb p-t-36 gallery-lb">
						...
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="images/gallery-02.jpg" data-lightbox="gallery"
								style="background-image: url('images/gallery-02.jpg');object-fit: cover;"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="images/gallery-03.jpg" data-lightbox="gallery"
								style="background-image: url('images/gallery-03.jpg');object-fit: cover;"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="images/gallery-04.jpg" data-lightbox="gallery"
								style="background-image: url('images/gallery-04.jpg');object-fit: cover;"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="images/gallery-05.jpg" data-lightbox="gallery"
								style="background-image: url('images/gallery-05.jpg');object-fit: cover;"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="images/gallery-06.jpg" data-lightbox="gallery"
								style="background-image: url('images/gallery-06.jpg');object-fit: cover;"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="images/gallery-07.jpg" data-lightbox="gallery"
								style="background-image: url('images/gallery-07.jpg');object-fit: cover;"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="images/gallery-08.jpg" data-lightbox="gallery"
								style="background-image: url('images/gallery-08.jpg');object-fit: cover;"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="images/gallery-09.jpg" data-lightbox="gallery"
								style="background-image: url('images/gallery-09.jpg');object-fit: cover;"></a>
						</div>
					</div>
				</div>
						...
						<div class="wrap-slick2">
							<div class="slick2">
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/VCL01.png" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="/web/VCL11.png" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/P1FR06.png" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/VCL15.png" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/VIN-P0802.png" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/VSL03.png" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/VSL16.png" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/VSL12.png" alt="IMG-PRODUCT">
						...
						<div class="wrap-slick2">
							<div class="slick2">
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/plotter-devia-blanco-50laminas.jpg" height="442.031"
												alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/Plotter-Devia-Compact-Tablet_115-laminas.png" height="442.031"
												alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/Plotter-Devia-Compact-15-Tablet_115-laminas.png"
												height="442.031" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="web/Plotter-15-mas-vendido.jpg" height="442.031"
												alt="IMG-PRODUCT">
			...
			<div class="container-fluid">
						...
						<div class="" data-aos="fade-up">
							...
							<div class="card">
								<p class="post"> <span><img class="quote-img"
									...
									<span class="post-txt">I upgraded my Dribble account to the Pro version. Absolutely
										loving the super clean look of the Playbook feature </span> <span><img
											class="nice-img" src="https://i.imgur.com/l5AkSHd.png"></span> </p>
							</div>
							<div class="arrow-down"></div>
						</div>
						<div class="row d-flex justify-content-center" data-aos="zoom-in">
							<div class=""> <img class="profile-pic fit-image" src="{{ asset('img/about/team-1.jpg') }}">
							</div>
							<p class="profile-name">Fernando Lozada</p>
						</div>
					</div>
				</div>
				{{-- PopChat rigth --}}
				<div class="row justify-content-end m-30 ">
					<div class=" col-sm-11 col-md-9 col-lg-8 col-xl-7">
						<div class="" data-aos="fade-up">
							...
							<div class="card-r">
								<p class="post"> <span><img class="quote-img-r"
									...
									<span class="post-txt">I upgraded my Dribble account to the Pro version. Absolutely
										loving
										the super clean look of the Playbook feature </span> <span><img
											class="nice-img-r" src="https://i.imgur.com/l5AkSHd.png"></span> </p>
							</div>
							<div class=" arrow-down-r"></div>
						</div>
						<div class="row d-flex justify-content-end pr-4" data-aos="zoom-in">

							<p class="profile-name-r ">Alejandro Méndez</p>
							<div class="mt-2"> <img class="profile-pic-r fit-image-r"
				...
				<div class="row justify-content-start">
					<div class=" col-sm-11 col-md-9 col-lg-8 col-xl-7">
						...
						<div class="row d-flex justify-content-center" data-aos="zoom-in">
							<div class=""> <img class="profile-pic fit-image" src="https://i.imgur.com/RCwPA3O.jpg">
							</div>
				...
				<div class="row justify-content-end m-30 ">
					<div class=" col-sm-11 col-md-9 col-lg-8 col-xl-7">
						...
						<div class="row d-flex justify-content-end pr-4" data-aos="zoom-in">
							...
							<p class="profile-name-r ">Manuel Tadeo</p>
							<div class="mt-2"> <img class="profile-pic-r fit-image-r"
