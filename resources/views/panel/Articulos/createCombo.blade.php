...
<section class="section">
    <div class="section-header">
        ...
        <h1>Crear un nuevo combo</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="/panel/tienda">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="#">Combo</a></div>
            <div class="breadcrumb-item">Crear Combo</div>
        </div>
    </div>

    <div class="section-body">
        <h2 class="section-title">Crear Combo</h2>
        <p class="section-lead pb-0 mb-0">
            En esta página se pueden crear combos destinados a la tienda, solo debe rellenar los siguientes campos.
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Productos</label>
                            <div class="col-sm-12 col-md-7">
                                <select class="form-control select2" id="productos" multiple="">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="input-group">
                                    ...
                                    <input min="0" id="precio" type="number" step="any" class="form-control currency"
                                        required>
                                </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <button class="btn btn-primary" id="saveBtn">Crear Combo</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="{{ asset('js/ComboCreate.js') }}"></script>
