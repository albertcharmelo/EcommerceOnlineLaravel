...
<head>
  ...
  <title>DEVIA | OLVIDÉ MI CONTRASEÑA</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{ asset('assets/img/Bonao_logo.png') }}" alt="logo" width="300" class="">
            </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <p class="text-muted">Enviaremos un link a tu correo eléctronico para restablecer tu contraseña</p>
